#
# Module manifest for module 'PsSqlTestServer'
#
# Generated by: Steffen Kampmann
#
# Generated on: 13.03.2022
#
...
RequiredModules = @(@{ ModuleName = 'PsSqlClient'; RequiredVersion = '1.5.0' })
